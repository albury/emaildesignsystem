<table class="<?php echo ($class == "wrapper") ? "wrapper" : "row"; ?>" align="center" bgcolor="<?php echo $bgColor; ?>" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <th class="mobile-padding-top-mini mobile-padding-bottom-mini column has-columns" width="600"
            style="<?php echo $mainPadding; ?> color: <?php echo $txtColor; ?>; font-weight: 400; text-align: center; line-height:1;">
            <a href="https://writearoundthemurray.org.au/" style="text-decoration: none;">
                <img editable class="mobile-center" align="center" src="<?php echo $headerImage; ?>"
                    alt="Image" width="600" style="border: 0; display:block; width: 100%; max-width: 600px;">
            </a>
        </th>
    </tr>
