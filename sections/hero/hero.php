<table class="<?php echo ($class == "wrapper") ? "wrapper" : "row"; ?>" align="center" bgcolor="<?php echo $bgColor; ?>"
    ...
    <tr valign="middle" style="vertical-align: middle;">
        <th class="hide-on-mobile" width="120"
            style="padding-left: 0px; padding-right: 40px; font-weight: 400; text-align: left;line-height:1;">
        ...
        <th align="left" class="mobile-12 mobile-text-center" width="540"
            style="color: <?php echo $txtColor; ?>; padding-left: 0px; padding-right: 40px; font-weight: 400; text-align: left;">
            <div class="spacer" style="font-size: 70px; line-height: 70px;">&nbsp;</div>
            <h1 style="font-size: 40px; line-height: 42px; font-weight: 900; display:block; color: <?php echo $txtColor; ?>;"
