<table class="<?php echo ($class == "wrapper") ? "wrapper" : "row"; ?>" align="center" bgcolor="<?php echo $bgColor; ?>"
    ...
    <tr>
        <td class="mobile-collapsed mobile-padding-top-mini mobile-padding-bottom-mini mobile-no-padding"
            style="padding: 0px;">
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                <tr>
                            ...
                            <tr>
                                <td class="has-columns mobile-padding-bottom-mini"
                                    ...
                                    <div class="sans-serif">
                                        <h3 style="padding-bottom:10px;  font-size: 23px; line-height: 38px; font-weight: 700; display:block; color: <?php echo $txtColor; ?>;"
                                    ...
                                    <div class="sans-serif"
                                        ...
                                        <multiline label="Event Description">
                                            Cia ipsundae volupis ilique omnis adist, ut porerum cum fuga. Apis alicat
                                            ...
                                            suntium excest. See www.facebook.com/followradicalson</multiline>
                                    </div>
                                    <div class="hide-on-mobile" align="left" class="mobile-text-left"
                                        style="display:block; padding-top:30px; line-height:1;">
                                        <?php include $logo;?>
                                    </div>
                                </td>
                            </tr>
                                ...
                                <td class="has-columns sans-serif"
                                    ...
                                    <div class="sans-serif"
                                        ...
                                        <multiline label="Event Details">
                                            Sunday 18 November 1pm<br>
                                            Outdoor at the Albury Botanic Gardens<br>
                                            Free<br>
                                            Smoke-free / BYO alcohol is permitted<br>
                                            A limited number of chairs and tables are provided with ample space for your
                                            own picnic rug and cushions.
                                        </multiline>
                                    </div>
                                    <div class="spacer show-on-mobile"
                                        style="display:none; font-size: 20px; line-height: 20px;">&nbsp;</div>
                    ...
                    <th valign="top" width="13.33%" class="column hide-on-mobile">
                        <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%">
                            <tr>
                                <td class="sans-serif"
