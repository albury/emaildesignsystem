        ...
        <th class="column mobile-no-padding" width="640" style="<?php echo $mainPadding; ?>">
            <table class="row" cellpadding="0" cellspacing="0">
                ...
                <tr valign="top" style="vertical-align: top;">
                    <th class="column has-columns mobile-padding-bottom" width="310"
            ...
            <table class="row" cellpadding="0" cellspacing="0">
                <tr>
                    <th class="column has-columns" width="640" style="text-align: left;">
            ...
            <table class="row" cellpadding="0" cellspacing="0">
                <tr>
                    <th class="column has-columns" width="640" style="color: <?php echo $txtColor; ?>; font-weight: 400; text-align: left;">
                        <div class="sans-serif">
