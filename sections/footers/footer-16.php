<table class="<?php echo ($class == "wrapper") ? "wrapper" : "row"; ?>" align="center" bgcolor="<?php echo $bgColor; ?>"
    ...
    <tr class="mobile-full-width" valign="top" style="vertical-align: top;">
        <th class="column mobile-last" width="360" style="padding-left: 30px; padding-right: 10px;">
        ...
        <th class="column mobile-first" width="260" style="padding-left: 10px; padding-right: 30px;">
            <table cellpadding="0" width="100%">
                <tr>
