                    ...
                    <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            <td class="mobile-padding-bottom-mini" dir="ltr" valign="top" style="padding: 0px 20px; line-height:1;">
                                <img class="full" editable src="https://dummyimage.com/200x180/002A3A/FFF" width="200" border="0" style="height: auto; display:block; max-width:200px; font-size: 14px; line-height: 14px; color: <?php echo $txtColor; ?>;">
                            </td>
                        </tr>
                    </table>
                </th>
