<table class="<?php echo ($class == "wrapper") ? "wrapper" : "row"; ?>" align="center" bgcolor="<?php echo $bgColor; ?>" cellpadding="0" cellspacing="0">
    ...
    <tr valign="top" style="vertical-align: top;">
        <th class="column" width="640"
            style="padding-left: 30px; padding-right: 30px; font-weight: 400; text-align: left;">
            <?php include "/Users/lauren/Sites/email/components/elements/multiline-content-media.php";?>
            <?php include $button;?>
        </th>
    </tr>
    <?php include "/Users/lauren/Sites/email/components/spacer/inner-row-spacer-30.php";?>
